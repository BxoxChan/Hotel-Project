...
export default function TableNO({setTableDetails,tableDetails,onSubmit}) {
  ...
  const handleSubmit = (e) => {
    ...
    return (
    <form className='bg-white w-4/5 px-2 rounded-sm py-5 flex flex-col items-center font-Ubuntu' onSubmit={handleSubmit}>
        <header className='text-center text-2xl mb-2 font-bold font-serif'>Table. Details</header>
        <div>
        <h1>Please Enter Your Table No.</h1>
        <input type="text" name='table' value={tableDetails.table} onChange={handleChange} className='border p-2 border-orange-400'/>
        <h1>Enter Your Name</h1>
        <input type="text" name='name' value={tableDetails.name} onChange={handleChange} className='border p-2 border-orange-400'/>
        <h1>Enter your Phone no.</h1>
        <input type="text" name='phone'  value={tableDetails.phone} onChange={handleChange} className='border p-2 border-orange-400'/>
      </div>
