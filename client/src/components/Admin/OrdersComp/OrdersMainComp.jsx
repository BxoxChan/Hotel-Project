  ...
  return (
    <div className='border-black border-2 m-2 sm:m-5 h-full bg-white relative'>
       <div className='flex justify-around items-center  h-1/5 border-2'>
        ...
        <button className={activeComponent==='Resturant'?`rounded-sm border-2 sm:w-1/5  border-black bg-orangeD1 text-white p-2 font-bold`:`rounded-md border-2 sm:w-1/5 w-fit px-2 border-black bg-orange-400 text-white ` } onClick={() => handleButtonClick('Resturant')}>Resturant</button>
